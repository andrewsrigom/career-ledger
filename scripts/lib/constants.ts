...
export const PATHS = Object.freeze({
  ...
  resume: path.join(ROOT, 'content', 'public', 'resume.json'),
  ...
  activities: path.join(ROOT, '.career', 'private', 'activities'),
  workstreams: path.join(ROOT, '.career', 'private', 'workstreams'),
  ...
  projections: path.join(ROOT, '.career', 'private', 'projections'),
  contexts: path.join(ROOT, '.career', 'private', 'contexts'),
  state: path.join(ROOT, '.career', 'state'),
  reports: path.join(ROOT, '.career', 'reports'),
  publicationPreview: path.join(ROOT, '.career', 'reports', 'publication-preview'),
